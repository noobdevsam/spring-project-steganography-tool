...
public interface SteganographyService {
    ...
    /**
     * Downloads the stego image bytes for a given encoding id.
     * Returns DTO with filename, contentType and raw bytes ready to be sent to client.
     */
    StegoDownloadDTO downloadStegoImage(UUID id) throws StegoDataNotFoundException;
