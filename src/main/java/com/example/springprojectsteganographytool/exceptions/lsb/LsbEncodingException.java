...
/**
 * Exception thrown when an error occurs during the encoding process
 * of LSB (Least Significant Bit) steganography.
 * This exception extends the {@link StegoException} class and provides
 * specific error code and HTTP status for LSB encoding failures.
 */
public class LsbEncodingException extends StegoException {
     ...
     *
     * @return {@link StegoErrorCode#ENCODE_FAILURE} indicating the error code
     */
    @Override
